...
ROOT_URLCONF = 'automated_emerging_cyber_threat_identification.urls'
...
WSGI_APPLICATION = 'automated_emerging_cyber_threat_identification.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'automated_emerging_cyber_threat_identification',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
