...
from automated_emerging_cyber_threat_identification import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Cyber_Threat_Identification_Type/$', remoteuser.Predict_Cyber_Threat_Identification_Type, name="Predict_Cyber_Threat_Identification_Type"),
    ...
    url(r'^View_Predicted_Cyber_Threat_Identification_Type_Ratio/$', serviceprovider.View_Predicted_Cyber_Threat_Identification_Type_Ratio, name="View_Predicted_Cyber_Threat_Identification_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Cyber_Threat_Identification_Type/$', serviceprovider.View_Predicted_Cyber_Threat_Identification_Type, name="View_Predicted_Cyber_Threat_Identification_Type"),
